...
Preliminaries: Structures and Pointers in C; Abstract Data Types (ADTs); List ADT: Array implementation of lists -- Linked lists --
Circular linked lists -- Doubly linked lists -- Applications of Lists:
Polynomial manipulation -- Hashing: Separate chaining -- Open addressing -- Rehashing
