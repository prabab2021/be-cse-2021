...
- Understand the mathematical part of formal proofs, deduction techniques, inducttion proofs, languages and Construct automata for the given lanuage
- Understand the relationship between Finite Automata and regular expression (K3)
