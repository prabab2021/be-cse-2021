...
** COURSE OBJECTIVES
- To outline data warehouse concepts, architecture, business
  analysis and tools
- To apply data pre-processing and data visualization techniques
- To select algorithms for finding hidden and interesting patterns in
  data
- To compare and choose the classification techniques for real world problems
- To  apply various clustering techniques.
