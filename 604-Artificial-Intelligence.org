...
- To Learn the some appliactions in text, image and robotics.
...
Natural Language Processing: Language Models -- Information Retrieval; Perception: Image Formation -- Image-Processing Operations -- Object Recognition; Robotics: Introduction -- Robotic Hardawre -- Perception -- Application Domains.
...
- Illustrate different application domains of (K2)
