...
Added : Saraswathi : suggested by BB: after Recognition of tokens added  "Conversion of Regular expression to DFA"
#+end_comment
...
Suggestion: Saraswathi : Unit 5 BB, BP, DT Subject handling staff told that this unit LLVM is new topic and after completing this semester they will give their feedback on LLVM
...
- Build syntax directed translation for programming language
  constructs (K3)
- Outline and develope a simple code generator (K3)
