...
- To explain Object-relational and NOSQL databases.
...
{{{unit}}}
| UNIT V | OBJECT-RELATIONAL AND NOSQL DATABASES | 8 |
Overview of Object Database concepts -- Object database extensions 
to SQL; Introduction to NOSQL Systems -- The CAP Theorem -- Document-Based
NOSQL Systems and MongoDB.

#+begin_comment
Added a new topic, Object-relational databases and removed the NOSQL databases other than MongoDB.
#+end_comment
...
- Explain the concepts of Object-relational and NOSQL databases (K2).
